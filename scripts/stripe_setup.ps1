...
$STRIPE_SECRET_KEY = Prompt-For-Input -promptText "Enter your Stripe secret key: " -errorMessage "Stripe secret key cannot be empty. Please try again." -asSecureString

# Prompt for product names
$FREE_PRODUCT_NAME = Prompt-For-Input -promptText "Enter your FREE product name: " -errorMessage "FREE product name cannot be empty. Please try again."
$PRO_PRODUCT_NAME = Prompt-For-Input -promptText "Enter your PRO product name: " -errorMessage "PRO product name cannot be empty. Please try again."
...
try {
    ...
    $PRO_PRICE_ID = New-StripePrice -productId $PRO_PRODUCT_ID -unitAmount 1000 -currency "usd" -interval "month" -productName $PRO_PRODUCT_NAME -secretKey $STRIPE_SECRET_KEY
